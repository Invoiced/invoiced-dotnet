...
namespace Invoiced
{
    public class ChargeRequest : AbstractItem
    {
        ...
        [JsonProperty("payment_source_type")] public string PaymentSourceType { get; set; }

        [JsonProperty("payment_source_id")] public long? PaymentSourceId { get; set; }

        [JsonProperty("vault_method")] public bool? VaultMethod { get; set; }
